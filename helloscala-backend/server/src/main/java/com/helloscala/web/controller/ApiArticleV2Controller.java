...
public class ApiArticleV2Controller {
    ...
    public Response<Page<APIRecommendedArticleView>> selectArticleList(@RequestParam(name = "categoryId", required = false) String categoryId,
        ...
        Page<APIRecommendedArticleView> recommendedArticleViewPage = articleService.selectArticleList(userId, categoryId, tagId, orderByDescColumn);
    ...
    public Response<Page<APIRecommendedArticleView>> listByUserId(@RequestParam(name = "userId", required = true) String userId,
                                                             @RequestParam(name = "type", required = false) Integer type) {
        Page<APIRecommendedArticleView> listArticleVOPage = articleService.listByUserId(userId, type);
